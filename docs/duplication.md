...
|---|---|
| The 200-line orchestration, six times | `bin/update_pipeline.sh`, vendored in the image |
| The update and build workflows, six times | `.github/workflows/cache-update.yml`, `.github/workflows/cache-image.yml` |
